...
function Header() {
  return (
    <div className="flex-centered relative bg-[url(../../assets/bgIMG.png)] bg-cover bg-repeat bg-center flex-1 w-full h-full flex-row pt-32 px-8 pb-0 min-[2000px]:pt-40 max-[1200px]:flex-col max-[450px]:pt-24 max-[450px]:px-4 max-[450px]:pb-8">
      <motion.div
      ...
      >
        <div className="w-full flex justify-end items-end max-[1200px]:justify-start max-[1200px]:items-start flex-col">
          <div className="bubble flex-row flex-centered">
            <span className="text-5xl min-[2000px]:text-8xl">👋</span>
        ...
        {[images.flutter, images.redux, images.sass].map((circle, index) => (
          <div
            ...
            className={`flex-centered w-[100px] h-[100px] rounded-full bg-white shadow-[0_0_20px_rgba(0,0,0,0.1)] 
              ...
              min-[2000px]:first:w-[250px] min-[2000px]:first:h-[250px] 
              min-[2000px]:even:m-5 min-[2000px]:even:w-[170px] min-[2000px]:even:h-[170px] 
              min-[2000px]:last:w-[120px] min-[2000px]:last:h-[120px]
              max-[1200px]:m-4
            `}
          >
